package namnh.clean.shared.adapter.basic
...
import namnh.clean.shared.adapter.RecyclerType
import namnh.clean.shared.adapter.RecyclerViewItem
import namnh.clean.shared.adapter.TYPE_UNKNOWN
...
abstract class BasicAdapter : RecyclerView.Adapter<BaseViewHolder<in RecyclerViewItem>>() {
    ...
    final override fun getItemViewType(position: Int): Int {
        return getItem(position)?.type ?: TYPE_UNKNOWN
    }
